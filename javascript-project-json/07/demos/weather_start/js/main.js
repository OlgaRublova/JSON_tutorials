...
// GET THE CONDITIONS
weatherConditions.open('GET', '//api.openweathermap.org/data/2.5/weather?zip=91303,us&appid=f0127f27d77bdb6e72b0f8e82bbb2806&units=imperial', true);
...
document.getElementById('desc').innerHTML = "Wind speed is "+cObj.wind.speed+" m/s";
...
// GET THE FORECARST
weatherForecast.open('GET', 'http://api.openweathermap.org/data/2.5/forecast?zip=84653,us&appid=f0127f27d77bdb6e72b0f8e82bbb2806&units=imperial', true);
